...
## Fixes
- Fixed UI for a field containing an array of pointers [#1775](https://github.com/parse-community/parse-dashboard/issues/1775) (Prerna Mehra) [#1776](https://github.com/parse-community/parse-dashboard/pull/1776)
