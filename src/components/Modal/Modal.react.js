...
const Modal = ({
  ...
  const footer = customFooter || (
    <div
      style={{ textAlign: buttonsInCenter ? 'center' : 'right' }}
      className={styles.footer}
    >
      {showCancel && (
        <Button value={cancelText} onClick={onCancel} disabled={!canCancel} />
      )}
      {showContinue && (
        <Button
          primary={true}
...
Modal.propTypes = {
  ...
  icon: PropTypes.string.describe(
    'The Icon to display in the top right corner.'
  ),
  iconSize: PropTypes.number.describe(
    'The size of the Icon in the top right corner.'
  ),
  title: PropTypes.string.isRequired.describe('The title of the modal.'),
  subtitle: PropTypes.node.describe(
    'The subtitle of the modal. Usually a string or <span>.'
  ),
  cancelText: PropTypes.string.describe(
    'String for the cancel button. Defaults to "Cancel".'
  ),
  onCancel: PropTypes.func.describe(
  ...
  confirmText: PropTypes.string.describe(
    'String for the confirm button. Defaults to "Okay".'
  ),
  onConfirm: PropTypes.func.describe(
  ...
  customFooter: PropTypes.node.describe(
    'used to fill any custom footer use case.'
  ),
  textModal: PropTypes.bool.describe(
    'Used for modals that contain only text to pad the text.'
  ),
