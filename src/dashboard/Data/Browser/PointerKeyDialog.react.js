  ...
  render() {
    ...
    return (
      <Modal
        ...
        subtitle={
          hasColumns
            ? `The selected column will be used to represent a pointer for class "${this.props.className}"`
            : `There are no columns that can be set to represent a pointer for class "${this.props.className}"`
        }
        confirmText="Change"
        cancelText="Cancel"
