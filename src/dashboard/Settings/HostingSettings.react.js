...
export default class HostingSettings extends DashboardView {
  ...
  renderForm({fields, setField}) {
    const hostingSubdomainFields = <Fieldset
    ...
    const customDomainsFields = <Fieldset
    ...
    const emailSettingsFields = <Fieldset
    ...
    const emailTemplatesFields = <Fieldset
    ...
    const userFacingPagesFields = <Fieldset
    ...
    const whiteLabelURLsFields = <Fieldset
