  ...
  renderForm({ fields, setField }) {
    ...
    const customDomainsFields = (
      ...
      >
        <Field
          ...
          label={
            <Label
              text="Host name"
              description={
                'A host with a subdomain CNAME entry set to ' +
                (fields.subdomain_name || '[your subdomain name]') +
                '.parseapp.com'
              }
            />
          }
        ...
        <Field
          ...
          label={
            <Label
              text="Host Name Key"
              description={
                'To claim a host name like "www.example.com", either "www.example.com" or "' +
                (fields.host_name_key || '') +
                '.www.example.com" must resolve to "' +
                (fields.subdomain_name || '[your subdomain name]') +
                '.parseapp.com".'
              }
            />
        ...
        />
        <FormNote show={this.state.sslPublicCertError.length > 0} color="red">
        ...
        {this.state.sslPrivateKeyError.length > 0 ? (
          <FormNote show={this.state.sslPrivateKeyError.length > 0} color="red">
