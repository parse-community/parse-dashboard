...
module.exports = (options) => {
  ...
  const cookieMaxAge = options.cookieMaxAge || process.env.PARSE_DASHBOARD_COOKIE_MAX_AGE;
  ...
  let dashboardOptions = { allowInsecureHTTP, cookieSessionSecret, dev, cookieMaxAge };
