...
| `apps.masterKey`                       | String / () => string         | yes          | -           | `"myMasterKey"` or `() => "myMasterKey"` | The master key for full access to your Parse Server. It can be provided directly as a string or as a function returning a string.        |
