...
Get started by cloning this repository and and running `npm install` inside it. Update `parse-dashboard-config.json` in the `Gemforce-Dashboard` folder inside the repo, using the format described in the `README.md`.
